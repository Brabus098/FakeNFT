...
- **Рейтинг пользователей** с профилями и коллекциями
...
> **Примечание:** Проект демонстрирует владение современным iOS стеком - SwiftUI, MVVM, Swift Concurrency, actor-based сервисы. Полное соответствие техническому заданию и дизайн-макетам Figma.
